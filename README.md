...
| [`widgets/marquee.js`](widgets/marquee.js) | Бесшовная бегущая строка (петля на -50%) | `.marquee-wrapper` | GSAP |
| [`widgets/amount-counter.js`](widgets/amount-counter.js) | Барабан-счётчик суммы, +15 каждые 15–20 сек | `.amount-counter` | Odometer 0.4.7 |
